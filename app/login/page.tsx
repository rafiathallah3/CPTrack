  ...
  return (
    <div className="flex flex-1 items-center justify-center min-h-[calc(100vh-4rem)] p-4 bg-cp-bg">
      <div className="w-full max-w-sm cp-border bg-cp-bg">
        ...
        <div className="p-6">
          <p className="text-cp-muted font-mono text-sm mb-6">Enter your credentials to access the contest arena.</p>
        ...
        <div className="cp-border-t bg-cp-panel/30 px-4 py-3 text-center text-xs font-mono text-cp-muted">
          ...
          <Link href="/register" className="text-cp-active hover:underline font-bold transition-colors duration-200 cp-focus cp-focus:focus-visible rounded-sm">
            Register now
          </Link>
        </div>
      </div>
